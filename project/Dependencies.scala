...
object Dependencies {
  ...
  val LightbendConfig = "com.typesafe" % "config" % "1.4.2"
  ...
  val AkkaInfluxDB = "com.lightbend.akka" %% "akka-stream-alpakka-influxdb" % "3.0.4"
  ...
  val MockitoScala = "org.mockito" %% "mockito-scala" % "1.17.5" % Test
